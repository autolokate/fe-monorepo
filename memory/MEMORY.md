...
| `project-open-issues.md`         | _See PROJECT_STATUS open issues_                            |
| `project-known-decisions.md`     | _See ARCHITECTURE_PRINCIPLES.md + CLAUDE_PROJECT_INDEX §12_ |
| `project-route-map.md`           | _See CLAUDE_PROJECT_INDEX §2–3_                             |
| `project-component-inventory.md` | _See CLAUDE_PROJECT_INDEX §8_                               |
| `project-signoff-status.md`      | _See PROJECT_STATUS signoff table_                          |
