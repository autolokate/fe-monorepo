...
export { AlPlateInput, formatPlateInput, type AlPlateInputProps } from './PlateInput/index.js';
export { AlRelationGrid, type AlRelationGridOption, type AlRelationGridProps } from './RelationGrid/index.js';
