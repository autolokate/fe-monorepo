...
| 03  | Verify · Mobile | `978:2294` | Collect reporter mobile + consent           | First action from 02 (if unverified) | Valid 10-digit mobile + consent | **Continue**                         | Disabled CTA; checkbox off/on; _Figma shows language switcher_ |
