...
| `disabled`                             | `Primary·Disabled`                   | Above footer: _"Add a name to continue"_ (R3/E3) |
...
| 1 rider purchased                                          | Show R0; description: _"You've already paid for 1 rider's cover…"_             |
...
| Error                                                      | Description: _"We couldn't load your rider cover"_; CTA: _"Try again"_         |
...
| ---------------- | -------------------------------------------------------------------- |
| Safe             | _"Add 1 person we'll alert if you're in a crash."_                   |
| Secure           | _"Add up to 2 people we'll alert if you're in a crash."_             |
| Shield / Shield+ | _"Add 1–3 people we'll alert if you're in a crash."_ (Figma default) |
...
| Max reached helper | _"You've added the maximum {max} contacts"_ (centered) | —                            | —                         |
...
| --------------------- | ----------------------------------------------------------------- | ------------------------------------------------- |
| R0 body               | _"…finish later from your profile."_                              | _"…finish anytime from your profile."_            |
| R1 body               | _"We'll send them a code on WhatsApp. Enter it here to confirm."_ | _"…so they know you've added them."_              |
| R3/E3 body            | _"Add their name and how they're related"_                        | _"Confirm their name and how they're related."_   |
| E0 trust              | _"Encrypted · only used to reach them in a crash"_                | _"…only ever used to reach them in an emergency"_ |
| E5 subtitle           | _"1 of 3 added · you can add 2 more"_                             | _"1 of 3 added — you can add up to 3."_           |
| R0 error              | _"We couldn't load your rider cover"_                             | Not implemented                                   |
| R3 error              | _"We couldn't save rider details"_                                | Not implemented                                   |
| E3/R3 disabled helper | _"Add a name to continue"_                                        | Not shown                                         |
...
| Primary CTA (loading) | _(spinner, no label change)_                                                                    |
| Primary CTA (offline) | _(disabled)_                                                                                    |
...
| Prefix            | +91                                                           |
| CTA               | Get OTP                                                       |
| Error             | Enter a valid 10-digit mobile number. _(code convention)_     |
| Offline helper    | No internet connection _(code convention)_                    |
