...
import { LayoutGrid, Package, ScanLine, Tag } from 'lucide-react';
...
/** Core product navigation — shown in desktop bar and mobile drawer. */
export const primaryNavItems: HeaderNavItem[] = [
  { label: 'How it works', href: '/how-it-works', icon: ScanLine },
  { label: 'Features', href: '/features', icon: LayoutGrid },
  { label: 'Pricing', href: '/pricing', icon: Tag },
  { label: 'Products', href: '/products', icon: Package },
];

/** Company links — desktop xl+ and mobile drawer. */
export const companyNavItems: HeaderNavItem[] = [
  { label: 'About', href: '/about-us' },
  { label: 'Team', href: '/team' },
  { label: 'Media', href: '/media' },
];

/** Secondary links — mobile drawer + footer. */
export const secondaryNavItems: HeaderNavItem[] = [{ label: 'Contact', href: '/contact-us' }];
