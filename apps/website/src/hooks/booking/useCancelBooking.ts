...
export function useCancelBooking(options: UseApiMutationOptions<unknown, string> = {}) {
  return useApiMutation<unknown, string>((bookingId: string) => cancelBooking(bookingId), {
