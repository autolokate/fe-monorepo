...
export const PRIVACY_SECTIONS: PolicySection[] = [
  {
    ...
    blocks: [
      {
        body:
          "This Privacy Policy explains how we collect, use, share, and safeguard information when you visit autolokate.com, use the Autolokate mobile app, scan an Autolokate QR sticker, or otherwise interact with our services (collectively, the \u201cService\u201d). By using the Service you agree to the practices described here.",
      },
      {
        body:
          "We follow a privacy-first approach: we collect only what is needed to operate the Service, store it securely, and never sell your personal information to third parties.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        body:
          "We may receive limited information from authentication providers, analytics partners, OEM catalogue feeds, and payment gateways. We use this information only for the purposes described in Section 3.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        body:
          "No method of transmission or storage is 100% secure. If we ever become aware of a data breach affecting your personal information, we will notify you and the appropriate authorities as required by applicable law.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        body:
          "To exercise any of these rights, email privacy@autolokate.com from the address linked to your account. We respond within the timeframes listed in Section 14.3.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        body:
          "You can control non-essential cookies through your browser settings. Disabling certain cookies may affect parts of the Service \u2014 for example, you may be signed out more frequently.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        body:
          "If you believe a child has provided us with personal information, please contact us at privacy@autolokate.com and we will take steps to delete that information promptly.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        body:
          "When we transfer personal information across borders, we rely on appropriate safeguards \u2014 such as standard contractual clauses or transfer-impact assessments \u2014 to ensure your data continues to receive an adequate level of protection.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        body:
          "When we make material changes, we will notify you via the Service or by email at least 7 days before the new policy takes effect. The \u201cLast updated\u201d date at the top of this page always reflects the most recent revision.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      {
        body:
          "These services have their own privacy policies. We encourage you to review them. Autolokate is not responsible for the privacy practices of third-party sites or services that are linked from the Service.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        rows: [
          ...
          },
          {
            ...
            value:
              "Third-party companies that provide services on our behalf under contract.",
          },
          {
            label: "User-Generated Content",
            value:
              "Any content created and shared by users within our Service.",
          },
        ],
      },
    ],
