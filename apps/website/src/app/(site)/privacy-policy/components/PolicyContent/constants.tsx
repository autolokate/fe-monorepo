    ...
    blocks: [
      {
        bullets: [
          ...
          'Payments: PCI-compliant processors such as Razorpay.',
    ...
    blocks: [
      {
        ...
        rows: [
          { label: 'Privacy Officer', value: 'privacy@autolokate.com' },
          { label: 'General Support', value: 'support@autolokate.com' },
          { label: 'Data Protection Officer', value: 'privacy@autolokate.com' },
        ],
      },
      {
...
export const PRIVACY_TOC = PRIVACY_SECTIONS.map((section) => ({
