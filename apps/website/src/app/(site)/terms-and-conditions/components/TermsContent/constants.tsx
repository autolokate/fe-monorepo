...
export const TC_SECTIONS: TermsSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        body: 'You are solely responsible for the User Content you submit. Autolokate may remove or refuse to display content that we believe violates these Terms, infringes third-party rights, or breaches applicable law.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      {
        body: 'Autolokate has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third-party services. You acknowledge and agree that Autolokate shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of, or reliance on, any such content, goods, or services available on or through any third-party site or service.',
      },
    ],
  },
  {
