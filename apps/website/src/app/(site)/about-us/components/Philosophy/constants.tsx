...
export const BELIEF_TILES: BeliefTile[] = [
  {
    id: 'automatic',
    title: 'The app watches your back.',
    body: 'Crash detection runs in the background—help can start even when you can’t reach your phone.',
  },
  {
    id: 'backup',
    title: 'When the phone can’t, the car can.',
    body: 'If your phone is unreachable or a bystander arrives first, the Smart QR works with any camera. No app. No login.',
  },
  {
    id: 'privacy',
    title: 'Your number stays private.',
    body: 'Park Me verifies the request, then an AI call reaches you. Your number is never shared.',
  },
  {
    id: 'record',
