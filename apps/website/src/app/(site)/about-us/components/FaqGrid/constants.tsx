...
export const FAQS: FaqItem[] = [
  {
    ...
    answer:
      'An app-first vehicle safety platform for India, built by Autolokate Software Private Limited. The app spots a serious crash without you touching the phone and gets help moving. The Smart QR on the vehicle is the backup that works even without the app.',
  },
  {
    id: 'replace',
