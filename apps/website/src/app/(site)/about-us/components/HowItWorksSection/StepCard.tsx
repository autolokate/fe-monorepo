  ...
  return (
    <article
      className={cn(
        ...
        highlighted
          ? "border-black/20 shadow-[0_4px_16px_rgba(0,0,0,0.08)] ring-1 ring-black/10"
          : "border-black/10",
        className,
      )}
    >
      <div className="flex items-center justify-between gap-3">
        <span
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#0a0a0a] text-white"
          aria-hidden
        >
          <Icon className="h-[1.125rem] w-[1.125rem] stroke-[1.75]" />
        </span>
        <span className="text-xs font-semibold tabular-nums tracking-wide text-black/40">
          {stepLabel}
        </span>
      </div>
