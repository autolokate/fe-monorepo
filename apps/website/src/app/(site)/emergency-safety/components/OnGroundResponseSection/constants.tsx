...
export const RESPONSE_BRANCHES: ResponseBranch[] = [
  ...
  },
  {
    ...
    body: `Towing and minor repairs · fuel delivery · flat tyre · battery jump-start · lockout help. Included on ${PLAN_DISPLAY_BY_SLUG.shield} and ${PLAN_DISPLAY_BY_SLUG['shield-plus']} plans.`,
    Icon: Wrench,
  },
];
