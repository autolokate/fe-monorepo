...
const SAFETY_KEY_RE = /safety|ncap|airbag|abs|ebd|esc|tpms|isofix|brake assist|crash/i;
...
export function buildCompareRowsForTab(
  ...
  if (tab === 'specs') {
    ...
    specKeys.sort((a, b) => labelForKey(a, taxonomy).localeCompare(labelForKey(b, taxonomy)));
